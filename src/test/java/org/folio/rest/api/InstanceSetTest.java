...
public class InstanceSetTest extends TestBaseWithInventoryUtil {
  ...
  public static void setupRecords() {
    instancesClient.create(instance(instanceId1));
    instancesClient.create(instance(instanceId2));
    instancesClient.create(instance(instanceId3));
    instancesClient.create(instance(instanceId4));
    instancesClient.create(instance(instanceId5));
    instancesClient.create(instance(instanceId6));
  ...
  public void canQueryByHrid() {
    var sets = getInstanceSets("hrid==in00000000002");
