...
public class HoldingsStorageTest extends TestBaseWithInventoryUtil {
  ...
  public void canCreateHolding() {
    ...
    JsonObject holding = holdingsClient.createDefault(holdingToCreate).getJson();
  ...
  public void canCreateHoldingWithoutProvidingAnId() {
    ...
    IndividualResource holdingResponse = holdingsClient.createDefault(holdingBuilder.create());
  ...
  public void canCreateHoldingAtSpecificLocation() {
    ...
    holdingsClient.attemptToReplace(holdingId.toString(), new HoldingRequestBuilder()
      .withId(holdingId)
      .forInstance(instanceId)
      .withSource(getPreparedHoldingSourceId())
      .withTags(new JsonObject().put("tagList", new JsonArray().add(TAG_VALUE)))
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID).create(),
      TENANT_ID, Map.of(XOkapiHeaders.URL, mockServer.baseUrl()));
  ...
  public void canReplaceHoldingAtSpecificLocation() {
    ...
    IndividualResource holdingResource = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(instanceId)
      .withSource(sourceId)
      .withTags(new JsonObject().put("tagList", new JsonArray().add(TAG_VALUE)))
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID).create());
  ...
  public void canMoveHoldingsToNewInstance() throws ExecutionException, InterruptedException, TimeoutException {
    ...
    IndividualResource holdingResource = holdingsClient.createDefault(holdingToCreate);
  ...
  public void canGetAllHoldings() {
    ...
    final UUID firstHoldingId = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(firstInstanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID).create()).getId();

    final UUID secondHoldingId = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(secondInstanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(ANNEX_LIBRARY_LOCATION_ID).create()).getId();

    final UUID thirdHoldingId = holdingsClient.createDefault(new HoldingRequestBuilder()
  ...
  public void canRetrieveAllHoldings() {
    ...
    final var firstHoldingId = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(firstInstanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID).create()).getId();

    final var secondHoldingId = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(secondInstanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(ANNEX_LIBRARY_LOCATION_ID).create()).getId();

    final var thirdHoldingId = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(thirdInstanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
      .withTags(new JsonObject().put("tagList", new JsonArray().add(TAG_VALUE))).create()).getId();
  ...
  public void cannotPageWithNegativeLimit() throws Exception {
    ...
    holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(instanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
      .create());
  ...
  public void canDeleteHoldingsByCql() {
    ...
    final var h1 = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(instanceId1)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
      .withHrid("1234")
      .create()).getJson();
    final var h2 = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(instanceId1)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
      .withHrid("21234")
      .create()).getJson();
    final var h3 = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(instanceId2)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
      .withHrid("12")
      .create()).getJson();
    final var h4 = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(instanceId2)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
      .withHrid("3123")
      .create()).getJson();
    final var h5 = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(instanceId2)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
      .withHrid("123")
  ...
  public void tenantIsRequiredForGettingHolding()
    ...
    UUID id = holdingsClient.createDefault(new HoldingRequestBuilder()
      .forInstance(instanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID).create()).getId();
  ...
  public void updatingHoldingsWithSourceIdShouldUpdate()
    ...
    UUID holdingId = UUID.randomUUID();
    JsonObject holding = holdingsClient.createDefault(new HoldingRequestBuilder()
      .withId(holdingId)
      .forInstance(instanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
  ...
  public void updatingHoldingsUpdatesItemEffectiveCallNumber()
    ...
    final JsonObject holding = holdingsClient.createDefault(new HoldingRequestBuilder()
      .withId(holdingId)
      .forInstance(instanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
  ...
  public void updatingHoldingsDoesNotUpdateItemsOnAnotherHoldings()
    ...
    final JsonObject firstHolding = holdingsClient.createDefault(new HoldingRequestBuilder()
  ...
  public void canCreateHoldingsWhenHridIsSupplied() {
    ...
    final JsonObject holdings = holdingsClient.createDefault(new HoldingRequestBuilder()
      .withId(holdingsId)
      .forInstance(instanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
  ...
  public void cannotCreateHoldingsWithHridFailure() {
    ...
    final JsonObject goodHholdings = holdingsClient.createDefault(new HoldingRequestBuilder()
      .withId(UUID.randomUUID())
      .forInstance(instanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
  ...
  public void cannotCreateHoldingsWhenAlreadyAllocatedHridIsAllocated() {
    ...
    // Allocate the HRID
    final var firstAllocation = holdingsClient.createDefault(holdingsRequest).getJson();
  ...
  public void canFilterByFullCallNumber() {
    ...
    final IndividualResource wholeCallNumberHolding = holdingsClient.createDefault(
  ...
  public void canFilterByCallNumberAndSuffix() {
    ...
    IndividualResource wholeCallNumberHolding = holdingsClient.createDefault(
      new HoldingRequestBuilder()
        .forInstance(instance.getId())
        .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
        .withSource(getPreparedHoldingSourceId())
    ...
    IndividualResource noPrefixHolding = holdingsClient.createDefault(
      new HoldingRequestBuilder()
        .forInstance(instance.getId())
        .withSource(getPreparedHoldingSourceId())
        .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
  ...
  public void canPostSynchronousBatchForConsortiumMember() {
    ...
    log.info("Starting canPostSynchronousBatchForConsortiumMember holdingsArray: {}", holdingsArray);
  ...
  public void canSearchByDiscoverySuppressProperty() {
    ...
    final IndividualResource suppressedHolding = holdingsClient.createDefault(
      new HoldingRequestBuilder()
        .forInstance(instance.getId())
        .withSource(getPreparedHoldingSourceId())
        .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
    ...
    final IndividualResource notSuppressedHolding = holdingsClient.createDefault(
      new HoldingRequestBuilder()
        .forInstance(instance.getId())
        .withSource(getPreparedHoldingSourceId())
        .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
    ...
    final IndividualResource notSuppressedHoldingDefault = holdingsClient.createDefault(
      new HoldingRequestBuilder()
        .forInstance(instance.getId())
        .withSource(getPreparedHoldingSourceId())
        .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID).create());
  ...
  public void shouldFindHoldingByCallNumberWhenThereIsSuffix() {
    ...
    final IndividualResource firstHoldingsToMatch = holdingsClient.createDefault(
      new HoldingRequestBuilder()
        .forInstance(instance.getId())
        .withSource(getPreparedHoldingSourceId())
    ...
    final IndividualResource secondHoldingsToMatch = holdingsClient.createDefault(
      new HoldingRequestBuilder()
        .forInstance(instance.getId())
        .withSource(getPreparedHoldingSourceId())
        .withCallNumber("GE77 .F73 2014")
  ...
  public void explicitRightTruncationCanBeApplied() {
    ...
    final IndividualResource thirdHoldingsToMatch = holdingsClient.createDefault(
      new HoldingRequestBuilder()
        .forInstance(instance.getId())
        .withSource(getPreparedHoldingSourceId())
        .withCallNumber("GE77 .F73 ")
  ...
  public void canSetHoldingStatementWithNotes() {
    ...
    IndividualResource holdingResponse = holdingsClient.createDefault(new HoldingRequestBuilder()
      .withId(holdingId)
      .forInstance(instanceId)
      .withSource(getPreparedHoldingSourceId())
      .withPermanentLocation(MAIN_LIBRARY_LOCATION_ID)
