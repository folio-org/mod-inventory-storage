DROP TRIGGER IF EXISTS set_instance_hrid ON ${myuniversity}_${mymodule}.instance_log CASCADE;
...
DROP TRIGGER IF EXISTS set_holdings_record_hrid ON ${myuniversity}_${mymodule}.holdings_record_log CASCADE;
...
DROP TRIGGER IF EXISTS set_item_hrid ON ${myuniversity}_${mymodule}.item_log CASCADE;
