...
public class LocationCampusClient implements StorageModuleClient<LocationCampus> {

  private static final String BASE_PATH = "/location-storage/campuses";

  private final RestClient restClient;

  public LocationCampusClient(RestClient restClient) {
  ...
  @Override
  public Future<HttpResponse<Buffer>> create(LocationCampus item, Map<String, String> headers) {
    return restClient.post(BASE_PATH, headers, item);
  }

  @Override
  public Future<HttpResponse<Buffer>> update(String id, LocationCampus item, Map<String, String> headers) {
