...
public class LocationLibraryClient implements StorageModuleClient<LocationLibrary> {

  private static final String BASE_PATH = "/location-storage/libraries";

  private final RestClient restClient;

  public LocationLibraryClient(RestClient restClient) {
  ...
  @Override
  public Future<HttpResponse<Buffer>> create(LocationLibrary item, Map<String, String> headers) {
    return restClient.post(BASE_PATH, headers, item);
  }

  @Override
  public Future<HttpResponse<Buffer>> update(String id, LocationLibrary item, Map<String, String> headers) {
