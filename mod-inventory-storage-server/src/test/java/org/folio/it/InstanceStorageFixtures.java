 ...
 */
public final class InstanceStorageFixtures {

  private InstanceStorageFixtures() {
  }

  public static String createInstanceType(HttpClient client) {
    return createInstanceType(client, null);
  }

  public static String createInstanceType(HttpClient client, String tenantId) {
   ...
   */
  public static String createInstanceType(HttpClient client, String tenantId, String id) {
  ...
  public static String createInstanceRelationshipType(HttpClient client) {
  ...
  public static String createInstance(HttpClient client, String title, String instanceTypeId) {
    ...
    var response = await(BaseIntegrationTest.doPost(client, ResourcePaths.INSTANCES, request));

    return response.bodyAsClass(Instance.class).getId();
  }

  public static String createInstance(HttpClient client, String title, String instanceTypeId, String tenantId) {
    var request = new InstanceRequestBuilder()
      .withTitle(title)
      .withSource("TEST")
      .withInstanceTypeId(UUID.fromString(instanceTypeId))
    ...
    var response = await(BaseIntegrationTest.doPost(client, ResourcePaths.INSTANCES, tenantId, request));

    return response.bodyAsClass(Instance.class).getId();
  }

  public static BaseIntegrationTest.TestResponse createInstanceRelationship(
    ...
    return await(BaseIntegrationTest.doPost(
   ...
   */
  public static JsonObject createInstanceRequest(UUID id, String source, String title, JsonArray identifiers,
