...
class RecordBulkIT extends BaseIntegrationTest {
  ...
  void shouldGetInstanceIds_usingDefaults() {
    ...
    var response = await(doGet(client, ResourcePaths.RECORD_BULK_IDS));
  ...
  void shouldGetInstanceIds_whenFieldParameterIsId() {
    ...
    var response = await(doGet(client, ResourcePaths.RECORD_BULK_IDS + "?field=id"));
  ...
  void shouldGetInstanceIds_withLimitAndOffset() {
    ...
    var response = await(doGet(client, ResourcePaths.RECORD_BULK_IDS + "?limit=5&offset=0"));
  ...
  void shouldGetInstanceIds_filteredByItemsEffectiveLocation() {
    ...
    var response = await(doGet(client, ResourcePaths.RECORD_BULK_IDS + query));
  ...
  void shouldGetHoldingsIds() {
    ...
    var response = await(doGet(client, ResourcePaths.RECORD_BULK_IDS + "?recordType=HOLDING"));
  ...
  void shouldGetHoldingsIds_withLimitAndOffset() {
    ...
    var response = await(doGet(client, ResourcePaths.RECORD_BULK_IDS + "?recordType=HOLDING&limit=5"));
  ...
  private static String createInstance(String title) {
    ...
    await(doPost(client, ResourcePaths.INSTANCES, request));
